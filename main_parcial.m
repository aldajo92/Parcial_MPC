...
%      u_batch = LQRBatch(R,Q,P,ssD.A,ssD.B,N,xsysbatch);

     [all_U] = MPC_restrict(ssD.A,ssD.B,xsysbatch,u_batch,[mpc_RefSignal(k);mpc_RefSignal(k)],N,N,P,Q,R,U_min,U_max,x_min,x_max,del_u_min,del_u_max);
     u_batch = all_U(1);
     UU_batch(k) = u_batch;
